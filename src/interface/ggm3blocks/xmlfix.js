Blockly.Xml.domToWorkspace = function(xml, workspace) {
  if (xml instanceof Blockly.Workspace) {
    var swap = xml; xml = workspace; workspace = swap;
...
Blockly.Variables.createVariable_ = function(workspace, id, opt_name, opt_type) { //Stops creation bug with variable names.
  var potentialVariableMap = workspace.getPotentialVariableMap();
  var realWorkspace = workspace.isFlyout ? workspace.targetWorkspace : workspace;
