(function () {
    ...
    Game.addEventListener("error", (err) => {
        ...
        loadingBarInnerText.textContent = "Error! Check browser developer tools for more info.";
    });
    ...
    function startInputHandling() {
        document.addEventListener("mousemove", (event) => {
            var pos = getMousePosition(event, gameCanvas, [gameCanvas.width, gameCanvas.height]);
